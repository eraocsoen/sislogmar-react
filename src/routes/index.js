...
const Tracer = React.lazy(() => import('../pages/tracer/Tracer'));
...
const LCLDashboard = React.lazy(() => import('../pages/dashboard/LCL'));
const InstantBookingDashboard = React.lazy(() => import('../pages/dashboard/InstantBooking'));
const PTPBookingDashboard = React.lazy(() => import('../pages/dashboard/PTPBooking'));
    ...
    return useRoutes([
        { path: '/', element: <Root /> },
        {
            ...
            children: [
                ...
                { path: 'tracer', element: <LoadComponent component={Tracer} /> },
                {
                    path: 'error-404',
            ...
            children: [
                ...
                },
                {
                    ...
                    children: [
                        {
                            path: 'lcl',
                            element: <LoadComponent component={LCLDashboard} />,
                        },
                    ],
                },
                {
                ...
                },
                {
                    ...
                    children: [
                        {
                            path: 'port-to-port-booking',
                            element: <LoadComponent component={PTPBookingDashboard} />,
                        },
                    ],
                },
                {
